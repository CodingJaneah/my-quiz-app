...
export default function HtmlQuizzes() {
    return (
        ...
        <main className="px-10">
            <h1 className="mt-[130px] text-center font-bold text-3xl">HTML Quizzes</h1>
            ...
            <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 mb-[200px] max-w-4xl mx-auto">
                ...
                <div className="border border-gray-300 rounded-lg p-6 shadow-md text-center hover:shadow-lg transition-shadow">
                    ...
                    <p className="text-gray-600 mb-4">Perfect for beginners learning HTML basics.</p>
                ...
                <div className="border border-gray-300 rounded-lg p-6 shadow-md text-center hover:shadow-lg transition-shadow">
                    ...
                    <p className="text-gray-600 mb-4">For those with some HTML experience.</p>
                ...
                <div className="border border-gray-300 rounded-lg p-6 shadow-md text-center hover:shadow-lg transition-shadow">
                    ...
                    <p className="text-gray-600 mb-4">Challenge yourself with advanced HTML concepts.</p>
