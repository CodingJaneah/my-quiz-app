...
/**
 * Easy JavaScript Quiz Page
 * Displays 10 easy-level JavaScript quiz questions
 */
/**
 * Easy JavaScript Quiz Page
 * Displays 10 easy-level JavaScript quiz questions
 ...
 */
export default function EasyJsQuiz() {
    const { user } = useAuth();
    ...
    useEffect(() => {
        const fetchAll = async () => {
            ...
            try {
                ...
                const response = await fetch('/api/quiz?type=javascript&difficulty=easy');
                ...
                if (data.success) {
                    ...
                    if (user?.id) {
                        const res = await fetch(`/api/user-answers?user_id=${user.id}&quiz_type=javascript&difficulty=easy`);
                        if (res.ok) {
        ...
        <main className="px-10 mt-[130px] mb-[200px] flex justify-start gap-24">
            ...
            <div className="w-[600px]">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <span className="text-yellow-400 font-semibold">JavaScript Easy Level</span>
                </div>
