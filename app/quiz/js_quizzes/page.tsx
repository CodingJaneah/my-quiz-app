 ...
 */
export default function JsQuizzes() {
    // Use the custom hook for each difficulty
    const easyStatus = useQuizStatus('javascript', 'easy');
    const mediumStatus = useQuizStatus('javascript', 'medium');
    const hardStatus = useQuizStatus('javascript', 'hard');
    const easyResult = useQuizResult('javascript', 'easy');
    const mediumResult = useQuizResult('javascript', 'medium');
    const hardResult = useQuizResult('javascript', 'hard');
    return (
        <>
        <Header />
